...
at `8f746b5`. MIT licensed — see `UPSTREAM-LICENSE`. Raw files resolved against
[VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) at `f696123`.
...
| RunwayML | `runwayml` | AI video generation. Cinematic dark UI, media-rich layout |
...
| Sanity | `sanity` | Headless CMS. Red accent, content-first editorial layout |
